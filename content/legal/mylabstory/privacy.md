---
title: Privacy Policy - MyLabStory
effectiveDate: June 6, 2026
description: Read the MyLabStory Privacy Policy covering how we collect, use, store, share, and protect your personal and health data, including OpenAI processing for document analysis and AI chat.
intro: This Privacy Policy explains how MyLabStory, a product operated under the Kritr brand by AI Brainiacs, collects, uses, stores, and protects your information when you use the MyLabStory mobile application, website, and related services. By accessing or using the Service, you acknowledge that you have read and understood this Privacy Policy and our Terms of Use.
---
...
- People on whose behalf Users provide information, such as family members, children, or other dependents whose health records are managed through the Service by an authorized User
...
- **You directly**, when you create an account, upload lab reports, enter health information, complete your profile, send messages through the AI chat assistant, or contact us
- **Automated processing**, when AI systems extract biomarker data from documents you upload or retrieve relevant health data to answer your chat questions
...
- **Health Data** including lab report files such as PDFs, JPEGs, and PNG images, extracted biomarker values, health summaries, trend data, and notes you add to your records
- **AI chat data** including your chat messages and conversation history within the App
...
- Power the AI chat assistant and respond to your questions about your health data
...
- Classify document type and date
- Generate summaries, insights, and trend analysis
- Identify patterns and anomalies in your biomarker data
- Retrieve relevant health data and generate AI assistant responses to your chat messages
...
- Your uploaded lab report files (PDF, JPEG, or PNG)
- Text extracted from those documents during processing

**Why we send it**

- To extract biomarker values and other health data from your documents
...
- Your chat messages
- Relevant health data retrieved to answer your questions, such as biomarker values, biomarker history, and document metadata (for example, document names, types, and dates). This may include health data from family member profiles you manage through the Service when relevant to your question
...
By using document analysis or AI chat features, you consent to MyLabStory sharing the data described above with OpenAI for these purposes, as also described in our Terms of Use.
...
We retain AI chat history for as long as your account is active or as needed to provide the Service. When you delete your account, we delete your chat history along with your other Personal Data, subject to any legal retention requirements.

Data sent to OpenAI for processing is handled according to OpenAI's policies and our agreements with OpenAI. We do not control OpenAI's internal retention practices for API requests.

### Subscription Data

If you cancel your paid subscription but maintain a free account, we may continue to store your previously uploaded data and chat history. If you delete your account entirely, we will delete your Personal Data, subject to any legal retention requirements.
...
- **Erasure**: You may request deletion of your Personal Data from our systems, including deletion of your account and associated Health Data and chat history. Please note that deleting certain data may prevent us from providing the Service to you
...
- **Withdrawal of Consent**: Where processing is based on your consent, including consent to share Health Data with OpenAI for AI features, you may withdraw that consent at any time. This may affect your ability to use certain features of the Service
...
## 9. Personal Data of Children and Dependents

MyLabStory is not intended for **independent use** by individuals under 18, or the applicable age of majority in your jurisdiction. However, parents, guardians, or other authorized individuals may upload and manage records for children or dependents for whom they are legally authorized to act.

If you use the Service to manage a child's or dependent's health records, you represent that you have the legal authority to provide that information and to consent to its processing on their behalf as described in this Privacy Policy.

We do not knowingly collect Personal Data directly from children who create accounts or use the Service on their own. If we learn that a child under the applicable age has created an account or used the Service independently without appropriate authorization, we will take steps to delete that information promptly.

If you believe a child may have created an account or provided Personal Data to us without proper authorization, please contact us at **mylabstory@kritr.com**.

---

## 10. Third-Party Sites and Services

The Service may contain links to or integrate with third-party websites, services, or platforms, such as sign-in providers, app stores, or payment processors. We are not responsible for the privacy practices of those third parties.

OpenAI is a data processor we use to deliver AI features, as described in Section 5. Other third-party integrations are separate from OpenAI processing.
...
- AI-generated insights, summaries, and chat responses are for informational purposes only
